...
const ToolBar: React.FC = () => {
    return (
        <nav className="flex flex-col md:flex-row md:justify-between md:items-center p-4 space-y-4 md:space-y-0">
            <div className="w-full md:w-fit flex flex-row justify-between items-center md:space-x-8">
                <h1 className="text-2xl font-bold font-mono">Lox Editor</h1>
